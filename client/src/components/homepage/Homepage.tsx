    ...
    <main>
      <div className="hero">
        <div className="hero-text">
          ...
          <p>
            All the best features from Excel sheets to track your bets on the go
          </p>
          <div className="hero-buttons">
            <Button className="btn">
              <h3 style={{ fontSize: "0.9rem" }}>register now</h3>
            </Button>
        ...
        <div className="alltime">
          ...
          <div className="text-wrapper">
            ...
            <p>
              ...
              winning percentage, sorts your bets by league or type, everything
              that you need to know you bets is found here.
            </p>
          </div>
        </div>
      </div>
